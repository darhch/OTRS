...
RUN chown -R otrs:www-data /opt/otrs && chmod -R 750 /opt/otrs && chmod -R 755 /opt/otrs/var/httpd/htdocs

RUN ls -l /opt/otrs && ls -l /opt/otrs/var/ && ls -l /opt/otrs/var/httpd/ && ls -l /opt/otrs/var/httpd/htdocs
